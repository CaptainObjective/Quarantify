...
const Activity = () => {
  ...
  const takeChallenge = activity => {
    ...
    updateScore(user, activity.points);
  };
  ...
  return (
    <>
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ width: '100%' }}>
          <div style={styles.newTitle}>New activity</div>
          <Card style={styles.newCard}>
            <div style={styles.newCard}>
              <span style={styles.newCardLabel}>Type activity</span>
              <span style={styles.newCardButton} onClick={() => setIsModalOpen(true)}>
                Add
              </span>
            </div>
          </Card>
          <div style={styles.newTitle}>Last activities</div>
          {user &&
            user.activities
          ...
          <Card style={styles.todaysChallengeCard}>
            <div style={styles.todaysChallengeCard}>
              <div style={styles.todaysChallengeCardTitle}>Today's challenge</div>
              <div style={styles.todaysChallengeCardSubtitle}>{todaysChallenge.name}</div>
              ...
              {isTodaysChallengeDone ? (
                <div>You've already done this challenge</div>
              ) : (
